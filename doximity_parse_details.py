...
# %%
specialties_1 = pd.read_csv('specialties_doximity_1.csv')
specialties_2 = pd.read_csv('specialties_doximity_2.csv')
specialties = specialties_1.append(specialties_2)
specialties.to_csv('specialties_doximity.csv')
