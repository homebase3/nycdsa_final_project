...
pickerInput('selected_filter','Show selected',choices= c(TRUE, FALSE),
            choicesOpt = c("Selected","Not selected"), multiple = T,
            options=list(`liveSearch` = T, `actions-box` = TRUE,size =10,
...
output$table <- DT::renderDataTable({
  ...
  if (input$selected_filter == TRUE) {
    df %<>% 
      filter(ID %in% selectedIDs())
  }
  if (input$selected_filter == FALSE) {
    df %<>% 
