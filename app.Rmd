...
```{r setup, context="setup", include=FALSE, cache=T}
# import packages
library(dplyr)
library(tidyr)
library(magrittr)
...
steps1 <- data.frame(element = c("#specialty-selectized","#section-applicant_sidebar","#section-overall-score","#step1Gauge", ".navbar"),
...
steps2 <-data.frame(element = c("#table", ".navbar ","#table","#table","#table","#section-range_gauge","#section-selectbar","#section-selectbar","#section-selectbar","#section-selectbar","#section-selectbar","#section-selectbar","#table"),
...
```{r}
pickerInput('range_filter','Program range',choices = c("Reach","Target","Safer"),
