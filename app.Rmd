...
output$table <- DT::renderDT({
  ...
  replace_indices <- sapply( names(colname_change_list), function(i) which(to_color == i)) %>% 
    as.numeric(.)
  to_color <- replace(to_color, replace_indices, as.character(colname_change_list))
  ...
  datatable(df, escape = F,
    ...
    formatStyle(.,columns = from_color[14],valueColumns = to_color[14],color = styleEqual(c(NA),c("#9954bb"),default = "#000"))
