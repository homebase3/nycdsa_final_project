...
pickerInput('selected_filter','Selection mode',choices = c("Selected","Not selected","All"),selected = "All", 
            multiple = F,options=list(`liveSearch` = T, `actions-box` = TRUE,size =10,
...
pickerInput('range_filter','Program range',choices = c("Reach","Target","Safer"),
            multiple = T,options=list(`liveSearch` = T, `actions-box` = TRUE,size =10,
                                      `selected-text-format` = 'count > 3'))
```
</details>
...
output$table <- DT::renderDataTable({
  ...
  if (input$selected_filter == "Selected") {
    df %<>% 
      filter(ID %in% selectedIDs())
  }
  else if (input$selected_filter == "Not selected") {
    df %<>% 
