...
output$valuebox_reach <- renderValueBox({
    valueBox(tags$p(difficulty_counts()[["Reach"]], style = "font-size: 100%; color: #fff"), caption = tags$p(paste0("reach programs selected"),style = "font-size: 100%; color: #fff"), color = "info", href = NULL)
})
```
