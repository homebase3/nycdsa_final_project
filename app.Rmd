...
steps2 <- data.frame(
  element = c("#table", ".navbar ", "#table", "#table", "#table", "#section-range_gauge", "#section-selectbar", "#section-selectbar", "#section-selectbar", "#section-selectbar", "#section-selectbar", "#section-selectbar", "#table"),
  intro = c(
    ...
    "Then click dowload a csv file with all of the information about your chosen programs. Please note that the app will not save your selections on, so make sure to do this to keep a record of your selection. Otherwise, you'll be starting from scratch the next time you open the app."
  )
)
...
fileInput("file1", "Import old selections", accept = c(".csv", ".xlsx"))
```
...
observeEvent(input$file1, {
  ...
  old_IDs <- old_select %>%
  X2021_Residency_selection_tool_2 %>% 
