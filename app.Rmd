...
steps2 <-data.frame(element = c("#table", ".navbar ","#table","#table","#table","#section-row-2","#section-selectbar","#section-selectbar","#section-selectbar","#section-selectbar","#section-selectbar","#selected_switch","#table"),
